...
function tradePage(){
 ...
 document.title=a.symbol+' / USD · Blu-Exchange';
 ...
 '<div class="terminal-grid"><div><section class="chart-panel" aria-label="Price history"><div class="quote-strip" id="quote-strip"></div><div class="chart-toolbar"><div><h2>Price chart</h2><p id="chart-source"></p></div><div class="segmented" aria-label="Chart range"><button data-range="1d" aria-pressed="'+(state.range==='1d')+'">1D</button><button data-range="7d" aria-pressed="'+(state.range==='7d')+'">7D</button></div></div><div id="chart-area"></div><div class="chart-caption"><span id="quote-time"></span><span id="chart-hover" class="chart-hover"></span></div></section>'+
...
function portfolioPage(){
 ...
 document.title=(account?'Account preview':orders?'Order previews':'Portfolio preview')+' · Blu-Exchange';
 ...
 main.innerHTML='<div class="page"><div class="section-intro"><span class="eyebrow">EXPLORE THE EXPERIENCE</span><h1>'+(account?'Account preview':orders?'A view of your activity.':'Your markets, in balance.')+'</h1><p>A sample portfolio for exploring Blu-Exchange. These holdings do not belong to an account.</p></div><nav class="screen-tabs" aria-label="Portfolio screens"><a href="/portfolio" data-nav class="'+(!orders&&!account?'active':'')+'">Holdings</a><a href="/orders" data-nav class="'+(orders?'active':'')+'">Order previews</a><a href="/user/account" data-nav class="'+(account?'active':'')+'">Account preview</a></nav>'+
